...
<div class="card p-4" style="height: calc(100vh - 160px);overflow: auto;">
  <div class="container-fluid">
    <div class="row">
      <div class="col sidebar mb-3">
        <h1><i class="fa fa-calendar" aria-hidden="true"></i> LOGGER</h1>
        <p class="text-muted" style="display: none"><i>by Rap2h</i></p>
  
        <div class="custom-control custom-switch" style="padding-bottom:20px;">
          <input type="checkbox" class="custom-control-input" id="darkSwitch" style="display: none">
          <label class="custom-control-label" for="darkSwitch" style="margin-top: 6px; display: none">Dark Mode</label>
        </div>
