            ...
            <i class="fas fa-file-download mr-2"></i> Exportar Todo
                ...
                <div style="position: relative">
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-6">
                        <div class="w-full">
                            <label for="countries"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400"><i
                        ...
                        <div class="w-full" style="display: {{ $showStartEndDate ? 'block' : 'none' }}">
                            <div class="grid grid-cols-2 gap-6">
                                <div class="w-full">
                                    <label for="msp_init"
                                        class="block text-sm font-medium text-gray-900 dark:text-gray-400"><i
                    ...
                    <div class="flex justify-between mb-1" style="align-items: center;">
                        <span class="text-base font-medium text-blue-700 dark:text-white">
                            <i id="startAllProcessPlay" class="fa-solid fa-play text-green-500" wire:loading.remove
                        ...
                        wire:click="stopProcess"></i> --}}
                            <i id="startAllProcessCharge" class="fa-solid fa-spinner fa-spin-pulse" wire:loading
                                wire:target="startProcess"></i>
                        </span>
                        <div class="w-full text-right">
                            <small id="progressTextType"></small>
                            <small id="progressText" class="text-xs font-medium text-blue-700 dark:text-white"> 0% (0 de
                                0
                                monitores)</small>
                ...
                <div class="w-full" x-data="{ open: true }">
                    ...
                    <ul id="customersList" x-show="open" style="height: calc(100vh - 425px);overflow: auto;"
